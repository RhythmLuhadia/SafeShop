...
# ===== REGULATORY DISCREPANCIES (FDA vs EU vs FSSAI) =====
REGULATORY_DISCREPANCIES = {
    "e171": {"eu": "banned", "usa": "allowed", "india": "allowed"},  # Titanium Dioxide
    "ins171": {"eu": "banned", "usa": "allowed", "india": "allowed"},
    "e129": {"eu": "warning_required", "usa": "allowed", "india": "allowed"}, # Red 40
    "ins129": {"eu": "warning_required", "usa": "allowed", "india": "allowed"},
    "e110": {"eu": "warning_required", "usa": "allowed", "india": "allowed"}, # Sunset Yellow
    "ins110": {"eu": "warning_required", "usa": "allowed", "india": "allowed"},
    "e102": {"eu": "warning_required", "usa": "allowed", "india": "allowed"}, # Tartrazine
    "ins102": {"eu": "warning_required", "usa": "allowed", "india": "allowed"},
...
# ===== FINAL SCORE =====
def final_score(product_or_n, a=None, allergies=None, region="global"):
    ...
    if a is not None:
        ...
        ingredients_list = product_or_n.get("tokens", product_or_n.get("ingredients", []))
    ...
    if region_lower != "global" and a.get("additives"):
        ...
        for add in flat_add:
            code = add.lower() if isinstance(add, str) else add.get("code", "").lower()
            if code in REGULATORY_DISCREPANCIES:
    ...
    if allergies and ingredients_list:
        ...
        for allergen in allergies:
            ...
            # Check structured ingredients + raw nutrition text
